...
{% img center /images/content_images/wills_desktop.jpg Will's desktop, with dozens of programs and files and beautiful graphics %}
...
{% img center /images/content_images/hardware_v_software.png The scientists study the hardware and software inside of the futuristic Mac %}
...
{% img center /images/content_images/biology_v_cognition.png Cognitive scientists study and imitate the physical and behavioral aspects of the human mind %}
